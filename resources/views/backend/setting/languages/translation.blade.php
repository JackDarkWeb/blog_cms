@extends("backend.layouts.default", ['title' => "Translation Language"])
...
@section("content")
    ...
    <div class="container-fluid">
        ...
        <form method="post" action="@if(isset($translation->name)) {{ route("translation.language.update", ["lang" => app()->getLocale(), "language" => $language->id, "to_lang" => $to_lang]) }} @else {{ route("translation.language.store", ["lang" => app()->getLocale(), "language" => $language->id, "to_lang" => $to_lang]) }} @endif" class="row pb-5">
            ...
            <div class="col-lg-6">
                <div class="card card-outline card-primary px-2">
                    ...
                    @include("backend.layouts.translation_languages", ["model" => "language"])
