@extends("backend.layouts.default", ['title' => "Create Page"])
...
<!-- Main content -->
       ...
       <div class="container-fluid">
           ...
           <form method="post" action="{{ route_name("manage-pages.store") }}" enctype="multipart/form-data" class="row">
                   ...
                   <div class="card  card-primary ">
                       ...
                       <div class="card-body">
                           ...
                           <div class="form-group">
                               ...
                               <input type="text" name="title" class="form-control" id="" placeholder="Enter name page" value="{{ old("title") }}">
