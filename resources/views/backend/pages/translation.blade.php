@extends("backend.layouts.default", ['title' => "Translation Page"])
...
@section("content")
    ...
    <div class="container-fluid">
        ...
        <form method="post" action="@if(isset($translation->title)) {{ route("translation.page.update", ["lang" => app()->getLocale(), "page" => $page->id, "to_lang" => $to_lang]) }} @else {{ route("translation.page.store", ["lang" => app()->getLocale(), "page" => $page->id, "to_lang" => $to_lang]) }} @endif" class="row pb-5" enctype="multipart/form-data">
            ...
            <div class="col-lg-6">
                ...
                <div class="card card-outline card-primary px-2">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="4" class="form-control"> {{ $page->sub_title }} </textarea>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="card card-outline card-primary px-2">
                    ...
                    @include("backend.layouts.translation_languages", ["model" => "page"])
