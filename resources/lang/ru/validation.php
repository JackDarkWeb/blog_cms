...
return [
    ...
    |
    */
    "success" => " :attribute успешно обновлён",
    "update" => ":attribute успешно создан",
    "destroy" => ":attribute успешно удалён",
    "translation" => "Есть проблема с переводом, пожалуйста, попробуйте еще раз.",

    'send_contact_message' => 'Мы получили ваше сообщение. Мы свяжемся с вами максимум через 24 часа.',
    'error_send_mail'=> "Извините, мы не смогли отправить ваше письмо. Попробуйте еще раз",
